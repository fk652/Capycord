...
const MessageDisplay = () => {
  // get channelid
  // if channel not part of server, redirect back to /server/:id url
  // check channels redux state
        ...
        <div className="actions-container">
          <div className="icon-wrapper">
            <svg x="0" y="0" class="icon-2xnN2Y" aria-hidden="true" role="img" width="24" height="24" viewBox="0 0 24 24">
              <path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M14 8.00598C14 10.211 12.206 12.006 10 12.006C7.795 12.006 6 10.211 6 8.00598C6 5.80098 7.794 4.00598 10 4.00598C12.206 4.00598 14 5.80098 14 8.00598ZM2 19.006C2 15.473 5.29 13.006 10 13.006C14.711 13.006 18 15.473 18 19.006V20.006H2V19.006Z">
              </path>
              <path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M14 8.00598C14 10.211 12.206 12.006 10 12.006C7.795 12.006 6 10.211 6 8.00598C6 5.80098 7.794 4.00598 10 4.00598C12.206 4.00598 14 5.80098 14 8.00598ZM2 19.006C2 15.473 5.29 13.006 10 13.006C14.711 13.006 18 15.473 18 19.006V20.006H2V19.006Z">
              </path>
          ...
          <div className="message-search-bar-wrapper">
            ...
            <div className="message-search-icon-wrapper">
              <svg className="message-search-empty" width="24" height="24" viewBox="0 0 30 30">
              ...
              <svg className="message-search-clear" width="24" height="24" viewBox="0 0 30 30" onClick={handleSearchClear}>
