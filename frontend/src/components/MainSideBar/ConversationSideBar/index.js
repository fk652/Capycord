    ...
    <div className="conversation-container">
      ...
      <div className="conversation-list">
        ...
        <ol>
          ...
          <br />
          <li>
            <strong>2. CAPYBARAS ARE FANTASTIC SWIMMERS</strong>
            <p>
          ...
          <br />
          <li>
            <strong>3. THEY CAN EVEN SLEEP IN WATER</strong>
            <p>
          ...
          <br />
          <li>
            <strong>4. BUT THEY’RE ALSO EXTREMELY AGILE ON LAND</strong>
            <p>
          ...
          <br />
          <li>
            <strong>5. THEY HAVE A UNIQUE VOCAL REPERTOIRE</strong>
            <p>
          ...
          <br />
          <li>
            <strong>6. THEIR TEETH GROW CONTINUOUSLY</strong>
            <p>
          ...
          <br />
          <li>
            <strong>7. OTHER ANIMALS USE CAPYBARAS LIKE FURNITURE</strong>
            <p>
          ...
          <br />
          <li>
            <strong>8. THEY’RE HIGHLY SOCIAL ANIMALS</strong>
            <p>
          ...
          <br />
          <li>
            <strong>9. AN ADULT CAPYBARA WEIGHS AS MUCH AS AN ADULT HUMAN</strong>
            <p>
          ...
          <br />
          <li>
            <strong>10. CAPYBARAS ARE HERBIVORES</strong>
            <p>
          ...
          <br />
          <li>
            <a href="https://currumbinsanctuary.com.au/stories/blogs/10-facts-about-capybaras-worlds-largest-rodents" target="_blank" rel="noopener noreferrer">
              original source
            </a>
          </li>
        </ol>
